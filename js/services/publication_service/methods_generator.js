window.methodsGenerator = (() => {
    ...
    function generateMriProtocolAndImageAnalysisHTML(stats, commonData) {
        ...
        return `
            ...
            <p><strong>T2-weighted (T2w) Criteria Assessment:</strong> The same radiologists evaluated the T2w images for four standard morphological features: size (short-axis diameter), shape (round vs oval), border (sharp vs irregular), and internal homogeneity (homogeneous vs heterogeneous). A patient with no visible T2w nodes was considered T2-negative. This feature set formed the basis for all subsequent comparative analyses.</p>
        `;
    }
