    ...
    function setPresentationView(newView) {
        if (newView === 'as-pur' || newView === 'as-vs-t2') {
            if (currentState.presentationView !== newView) {
                if (newView === 'as-pur') setPresentationStudyId(null);
                else if (!currentState.presentationStudyId) setPresentationStudyId(APP_CONFIG.SPECIAL_IDS.APPLIED_CRITERIA_STUDY_ID);
            }
